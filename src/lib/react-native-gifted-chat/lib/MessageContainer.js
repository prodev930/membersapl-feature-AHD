...
export default class MessageContainer extends React.PureComponent {
    ...
    constructor() {
        ...
        this.detachKeyboardListeners = () => {
            const { invertibleScrollViewProps: invertibleProps } = this.props;
            // Keyboard.removeListener('keyboardWillShow', invertibleProps.onKeyboardWillShow).remove();
            // Keyboard.removeListener('keyboardDidShow', invertibleProps.onKeyboardDidShow).remove();
            // Keyboard.removeListener('keyboardWillHide', invertibleProps.onKeyboardWillHide).remove();
            // Keyboard.removeListener('keyboardDidHide', invertibleProps.onKeyboardDidHide).remove();
